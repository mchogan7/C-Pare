...
//     queryWord: ["silver", "si", "Silver", "sliver", "Sliver"]
// }, {
//     targetWord: "COM/BUTTER",
//     queryWord: ["butter", "Butter", "buter", "Buter", "butt"]
// }]
...
//     }
    ...
    var queryURL = "https://www.quandl.com/api/v3/datasets/WIKI/COM/AG_USD.json?column_index=4&start_date=2015-01-01&end_date=" + today + "&collapse=daily&api_key=UMXpzxQFetfRt4EESdWK";
    $.ajax({ url: queryURL, method: "GET" }).done(function(response) {
...
//End of Quandle commodity AJAX Call
